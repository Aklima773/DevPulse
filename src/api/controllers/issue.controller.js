...
export const createIssue = async (req, res) => {
    ...
    try {
        ...
        return sendResponse(res, { message: "Issue created successfully", data: newIssue }, 201);
    }
    catch (error) {
...
export const getAllIssues = async (req, res) => {
    try {
        ...
        return sendResponse(res, { message: "Issues retrieved successfully", data: issues }, 200);
    }
    catch (error) {
        const errorMessage = error instanceof Error ? error.message : "An unknown error occurred";
        return sendResponse(res, { message: errorMessage }, 500);
...
export const getIssueById = async (req, res) => {
    try {
        ...
        return sendResponse(res, { message: "Issue retrieved successfully", data: issue }, 200);
    }
    catch (error) {
        const errorMessage = error instanceof Error ? error.message : "An unknown error occurred";
        return sendResponse(res, { message: errorMessage }, 500);
...
export const updateIssue = async (req, res) => {
    try {
        ...
        return sendResponse(res, { message: "Issue updated successfully", data: updatedIssue }, 200);
    }
    catch (error) {
